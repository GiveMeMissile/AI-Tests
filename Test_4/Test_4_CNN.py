...
class ClassifierCNN(nn.Module):
    def __init__(self, input_features, hidden_features, output_features=64):
        super().__init__()
        ...
        self.output_layer = nn.Sequential(
            nn.Flatten(),
            nn.Linear(in_features=hidden_features*64,
...
def main():
    ...
    model = ClassifierCNN(input_features=INPUT_FEATURES, output_features=OUTPUT_FEATURES,
