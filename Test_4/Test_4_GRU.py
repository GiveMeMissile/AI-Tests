...
# This is a simple GRU model used for text classification. Yay
class ClassificationGRU(nn.Module):
    def __init__(self, input_features, output_features, hidden_features, rnn_layers):
        ...
        self.input_GRU_layer = nn.GRU(input_size=input_features,
...
def main():
    ...
    model = ClassificationGRU(input_features=INPUT_FEATURES, output_features=OUTPUT_FEATURES,
